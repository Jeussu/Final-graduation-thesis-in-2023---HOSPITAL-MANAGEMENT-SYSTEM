...
2.1 Hospital management system	7
2.1.1 DOMAIN.	8
2.1.2 Electronic Health Record (EHR)	8
2.1.3 Options for storing healthcare data	9
2.1.4MODULES:	10
2.2 Hospital Management Software Faces Difficulties	12
2.2.1 Hospital Management Software Faces Difficulties in Viet Nam	13
2.3 HOSPITAL MANAGEMENT SYSTEM BENEFITS	14
2.4 Technologies	15
2.4.1 Java Swing	16
2.4.2  C#	18
2.4.3 .Java Fx	19
2.4.4 JavaScript	20
2.4.5 Database	21
2.5 Methodologies	23
2.5.1 Waterfall	23
2.5.2 Agile	24
3 Requirement Analysis	25
3.1 Similar application	25
3.2 Requirements	30
3.2.1 Functioning Requirements	30
3.2.2 Non-Functional Requirements	31
3.2.2.1 Usability	31
3.2.2.2 Security	31
3.2.2.3 Responsiveness	31
Conclusion	31
4 Design	31
4.1 Use case	31
4.2 Class diagram (optional)	35
4.3 	Database	36
4.4 	Activity	37
5. GUI DEVELOPMENT (WIREFRAMES)	39
6. Implementation	43
PROGRAMMING LANGUAGES SELECTED	43
Install libraries and add JDBC SQL derby for project	44
Four modules of system	46
7 Evaluation	52
7.1 Introduction	52
7.2 .Product Evaluation	52
7.2.1. Personal Evaluation	52
Human Interaction	53
Strengths of hospital management software	55
Weakness of hospital management software	56
7.5 Test Plan	57
8 Conclusion	57
8.1 Future works	58
8.2 Self-evaluation	58
8.3 CRITICAL REFLECTION	58
9 Appendix - TEST PLAN	59
9.1 Plan	64
References	64


LIST OF FIGURES 
Figure 1:Five Levels of Electronic Healthcare Records (EHR)	9
Figure 2: Hospital management system modules	11
Figure 3:The output of the SwingApplication1.java program (Perry Xiao, 2019)	17
Figure 4:The waterfall model	23
Figure 5:chart of Agile model	24
Figure 6:SoftClinic Hospital Management Software	26
Figure 7:User Appointment of SoftClinic system	27
Figure 8:SoftClinic Features.	27
Figure 9:eHealthFlex page	29
Figure 10:Hospital Reception System	32
Figure 11:use case diagram for admin of HMS	33
Figure 12:use case diagram for nurse of HMS	33
Figure 13:use case diagram for Doctor  of HMS	34
Figure 14:class diagram for Hospital Reception	35
Figure 15: API Class diagram	36
Figure 16:database diagram	36
Figure 17:Add Patient activity diagram	38
Figure 18:Create diagnosis activity diagram	39
Figure 19:add JDBC-derby for project	44
Figure 20:set Customize JDBC-derby for project	44
Figure 21:add libraries for import project	45
Figure 22:Database Colum in project	45
Figure 23:Structure of Java swing project	46
Figure 24:Confirm and query username and password login	47
Figure 25:Hash pass algorithm MD5	47
Figure 26:the first process when system run	48
Figure 27:the login form of HMS	48
Figure 28:homepage of Doctor and admin	49
Figure 29:Admin account management	49
Figure 30:Doctor account management	50
Figure 31:Patient module interface	51
Figure 32:Diagnosis module interface	52
Figure 33:search function and show diagnosis patient	53
Figure 34: The system will warn a user if their credentials are wrong.	54
Figure 35:The system's user interfaces are consistent (colors, fonts, ...)	54
Figure 36:The doctor can see each patient's diagnostic information without recalling the results.	55
Figure 37:Home Page	57
Figure 38:WBS for hospital management system.	64
Figure 39:Gantt chart for hospital management system.	64
 LIST OF TABLES 
Table 1:Functioning Requirements for HMS	30
Table 2: Add account Test Cases	60
Table 3: Test Cases for Login	60
Table 4: Test Cases for add Doctors	61
Table 5:Test Cases for add Patient	62
Table 6: Test Cases for add Diagnosis	63
